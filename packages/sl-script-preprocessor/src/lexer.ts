...
import { StringUri, ScriptLanguage, PreprocessorOptions } from "./interfaces";
...
export function getLanguageConfig(language: ScriptLanguage, config: PreprocessorOptions|null = null): LanguageLexerConfig {
    switch (language) {
        case "lsl":
            return {
                name: "lsl",
        ...
        case "txt": {
            const prefix = config?.notecard?.commentPrefix ?? null;
            return {
                name: "txt",
