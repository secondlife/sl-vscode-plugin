...
// @line 19 "file:///test/workspace/set_1/test_switch.lsl"
        integer i;
        if((i) == (1)) jump cb2d31;
        if((i) == (2)) jump c8ba57;
        if((i) == (3)) jump ca5466;
...
// @line 44 "file:///test/workspace/set_1/test_switch.lsl"
        if((i) == (1)) jump cd0f56;
        if((i) == (2)) jump ccc445;// colon optional as curly brace opens next
        jump cd702f;
        @cd0f56; // needs colon
        @ccc445;
        {
// @line 49 "file:///test/workspace/set_1/test_switch.lsl"
...
// @line 54 "file:///test/workspace/set_1/test_switch.lsl"
        ...
        @sc2783;
// @line 57 "file:///test/workspace/set_1/test_switch.lsl"
    }
}
